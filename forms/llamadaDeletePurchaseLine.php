...
<html>
    ...
    <div class="content">
        <h1><b>BORRAR LÍNEAS DE COMPRA</b></h1>
<?php
// Ruta al archivo deletePurchaseLine.php en tu servidor
$idCompra = $_GET['idCompra'];
$idProducto = $_GET['idProducto'];
$url_borrar_linea_compra="http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/deletePurchaseLine.php?idCompra=$idCompra&idProducto=$idProducto";


// Hacer la solicitud HTTP y obtener el XML como una cadena
$xmlString = file_get_contents($url_borrar_linea_compra);
...
$output = $xml->status;
if($output=="OK"){
    echo "<h1>La línea de compra se ha borrado correctamente.</h1>";
}else{
    if($output == "ERROR"){
