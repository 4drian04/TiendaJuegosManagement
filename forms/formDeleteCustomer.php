...
<head>
    ...
    <title>Borrar clientes de ARVID</title>
...
<body>
    ...
    <div class="formulario">
        ...
        <form action="llamadaDeleteCustomer.php">
            ...
            <input type="password" id="contrasenha" name="contrasenha" maxlength="8" class="form-control" required>
