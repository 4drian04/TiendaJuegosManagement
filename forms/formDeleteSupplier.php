...
<head>
    ...
    <title>Borrar productos de ARVID</title>
...
<body>
    ...
    <div class="formulario">
        ...
        <form action="llamadaDeleteSupplier.php">

            <label for="nombre">Proveedor:</label>
            <select name="nombre" id="nombre" class="form-select" required>
                <?php
                    $url_dame_productos = 'http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/readSupplier.php';
