...
<html>
    ...
    <div class="content">
        <h1><b>BORRAR CLIENTES</b></h1>
<?php
// Ruta al archivo deleteCustomer.php en tu servidor
$usuario = $_GET['usuario'];
$usuario=str_replace(" ", "+", $usuario);
$contrasenha = $_GET['contrasenha'];
$contrasenha=str_replace(" ", "+", $contrasenha);
$url_borra_clientes="http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/deleteCustomer.php?usuario=$usuario&contrasenha=$contrasenha";


// Hacer la solicitud HTTP y obtener el XML como una cadena
$xmlString = file_get_contents($url_borra_clientes);

// Verificar si la solicitud fue exitosa
if ($xmlString === FALSE) {
    die('Error al obtener el XML de deleteCustomer.php');
}
...
$output = $xml->status;
if($output=="OK"){
    echo "<h1>El usuario se ha borrado correctamente.</h1>";
}else{
    if($output == "ERROR"){
        echo "<h1>No se ha podido borrar el cliente.</h1>";
