...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Actualizar cantidad linea compra ARVID</title>
    ...
    <div class="content">
        <h1><b>CAMBIAR CANTIDAD DE PRODUCTO DE LINEAS DE COMPRA</b></h1>
<?php
// Ruta al archivo updateQuantityProductPurchaseLine.php en tu servidor
$idCompra = $_GET['idCompra'];
$idProducto = $_GET['idProducto'];
$cantidad = $_GET['cantidad'];
$url_cambiar_cantidad_producto_linea_compra="http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/updateQuantityProductPurchaseLine.php?cantidad=$cantidad&idCompra=$idCompra&idProducto=$idProducto";


// Hacer la solicitud HTTP y obtener el XML como una cadena
$xmlString = file_get_contents($url_cambiar_cantidad_producto_linea_compra);

// Verificar si la solicitud fue exitosa
if ($xmlString === FALSE) {
    die('Error al obtener el XML de createProduct.php');
}
...
$output = $xml->status;
if($output=="OK"){
    echo "<h1>La cantidad de la línea de compra de ha actualizado correctamente.</h1>";
}else{
    if($output == "ERROR"){
        echo "<h1>No se ha podido actualizar la cantidad de la línea de compra. Revise que el producto esté en la linea de compra seleccionada</h1>";
    }
}
?>
