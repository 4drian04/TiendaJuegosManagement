...
<head>
    ...
    <title>Cambiar cantidad de línea de compra ARVID</title>
...
<body>
    ...
    <div class="formulario">
        ...
        <form action="llamadaUpdateQuantityProductPurchaseLine.php">

            <label for="idCompra">Compras:</label>
            <select name="idCompra" id="idCompra" class="form-select" required>
                <?php
                    $url_dame_clientes = 'http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/readBuy.php';
                    ...
                    if ($xmlString === FALSE) {
                        die('Error al obtener el XML de readCustomer.php');
                    }
                    ...
                    foreach ($xml->compra as $compra) {
                        ?>
                        <option value="<?php echo $compra->idCompra; ?>">
                            <?php echo "{$compra->nombre} {$compra->primerApellido} {$compra->segundoApellido} -- {$compra->fecha}" ?>
                        </option>
                        <?php
                    }
                ?>
            ...
            <select name="idProducto" id="idProducto" class="form-select" required>
                <?php
                    $url_dame_clientes = 'http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/readProduct.php';
