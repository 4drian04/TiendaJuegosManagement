...
<html>
    ...
    <div class="content">
        <h1><b>BORRAR PRODUCTOS</b></h1>
<?php
// Ruta al archivo deleteProduct.php en tu servidor
$idProducto = $_GET['idProducto'];
$url_borrar_producto="http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/deleteProduct.php?idProducto=$idProducto";


// Hacer la solicitud HTTP y obtener el XML como una cadena
$xmlString = file_get_contents($url_borrar_producto);

// Verificar si la solicitud fue exitosa
if ($xmlString === FALSE) {
    die('Error al obtener el XML de deleteProduct.php');
}
...
$output = $xml->status;
if($output=="OK"){
    echo "<h1>El producto se ha borrado correctamente.</h1>";
}else{
    if($output == "ERROR"){
        echo "<h1>No se ha podido borrar el producto.</h1>";
    }
}
?>
