...
<html>
    ...
    <div class="content">
        <h1><b>BORRAR PROVEEDORES</b></h1>
<?php
// Ruta al archivo deleteSupplier.php en tu servidor
$nombre = $_GET['nombre'];
$nombre=str_replace(" ", "+", $nombre);
$url_borra_proveedor="http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/deleteSupplier.php?nombre=$nombre";


// Hacer la solicitud HTTP y obtener el XML como una cadena
$xmlString = file_get_contents($url_borra_proveedor);

// Verificar si la solicitud fue exitosa
if ($xmlString === FALSE) {
    die('Error al obtener el XML de deleteSupplier.php');
}
...
$output = $xml->status;
if($output=="OK"){
    echo "<h1>El proveedor se ha borrado correctamente.</h1>";
}else{
    if($output == "ERROR"){
        echo "<h1>No se ha podido borrar el proveedor. Es posible que este proveedor tenga pedidos que realizar</h1>";
    }
}
?>
