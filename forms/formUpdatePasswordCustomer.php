...
<body>
    ...
    <div class="formulario">
        ...
        <form action="llamadaUpdatePasswordCustomer.php">
            ...
            <select name="usuario" id="usuario" class="form-select" required>
                <?php
                    ...
                    foreach ($xml->cliente as $cliente) {
                        ?>
                        <option value="<?php echo $cliente->usuario; ?>">
            ...
            <label for="contrasenhaAntigua">Contraseña actual</label>
            <input type="password" id="contrasenhaAntigua" name="contrasenhaAntigua" maxlength="8" class="form-control" required>
            <label for="contrasenhaNueva">Contraseña nueva</label>
            <input type="password" id="contrasenhaNueva" name="contrasenhaNueva" maxlength="8" class="form-control" required>
