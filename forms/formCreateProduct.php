...
<head>
    ...
    <title>Productos de ARVID</title>
...
<body>
    ...
    <div class="formulario">
        ...
        <form action="llamadaCreateProduct.php">

            <label for="nombre">Nombre del producto:</label>
            <input type="text" id="nombre" name="nombre" maxlength="50" required>

            <label for="precio">Precio:</label>
            <input type="number" id="precio" name="precio" step="0.01" max="9999.99" class="form-control" required>

            <label for="plataforma">Plataforma:</label>
            <input type="text" id="plataforma" name="plataforma" maxlength="20">
