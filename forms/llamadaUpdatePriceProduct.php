...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Cambiar precio de productos de ARVID</title>
    ...
    <div class="content">
        <h1><b>CAMBIAR PRECIO DE PRODUCTO</b></h1>
<?php
// Ruta al archivo updatePriceProduct.php en tu servidor
$idProducto = $_GET['idProducto'];
$precio = $_GET['precio'];
$url_cambiar_precio_producto="http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/updatePriceProduct.php?idProducto=$idProducto&precio=$precio";


// Hacer la solicitud HTTP y obtener el XML como una cadena
$xmlString = file_get_contents($url_cambiar_precio_producto);

// Verificar si la solicitud fue exitosa
if ($xmlString === FALSE) {
    die('Error al obtener el XML de updatePriceProduct.php');
}
...
$output = $xml->status;
if($output=="OK"){
    echo "<h1>El precio del producto se ha cambiado correctamente.</h1>";
}else{
    if($output == "ERROR"){
        echo "<h1>No se ha podido cambiar el precio del producto.</h1>";
    }
}
?>
