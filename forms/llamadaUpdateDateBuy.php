...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Cambiar fecha de compra de ARVID</title>
    ...
    <div class="content">
        <h1><b>CAMBIAR FECHA DE COMPRA</b></h1>
<?php
// Ruta al archivo updateDateBuy.php en tu servidor
$idCompra = $_GET['idCompra'];
$fecha = $_GET['fecha'];
$url_cambiar_fecha_compra="http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/updateDateBuy.php?idCompra=$idCompra&fecha=$fecha";


// Hacer la solicitud HTTP y obtener el XML como una cadena
$xmlString = file_get_contents($url_cambiar_fecha_compra);

// Verificar si la solicitud fue exitosa
if ($xmlString === FALSE) {
    die('Error al obtener el XML de updateDateBuy.php');
}
...
$output = $xml->status;
if($output=="OK"){
    echo "<h1>La fecha de la compra se ha cambiado correctamente.</h1>";
}else{
    if($output == "ERROR"){
        echo "<h1>No se ha podido cambiar la fecha de la compra.</h1>";
    }
}
?>
