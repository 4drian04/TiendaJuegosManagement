...
<html>
    ...
    <div class="content">
        <h1><b>CAMBIAR TELÉFONO DE PROVEEDOR</b></h1>
<?php
// Ruta al archivo updatePhoneSupplier.php en tu servidor
$nombre = $_GET['nombre'];
$nombre=str_replace(" ", "+", $nombre);
$telefono = $_GET['telefono'];
$url_cambiar_telefono_proveedor="http://iescristobaldemonroy.duckdns.org:81/USER48/TiendaJuegosManagement/services/updatePhoneSupplier.php?nombre=$nombre&telefono=$telefono";


// Hacer la solicitud HTTP y obtener el XML como una cadena
$xmlString = file_get_contents($url_cambiar_telefono_proveedor);

// Verificar si la solicitud fue exitosa
if ($xmlString === FALSE) {
    die('Error al obtener el XML de updatePhoneSupplier.php');
}
...
$output = $xml->status;
if($output=="OK"){
    echo "<h1>El télefono del proveedor se ha actualizado correctamente.</h1>";
}else{
    if($output == "ERROR"){
        echo "<h1>No se ha podido actualizar el télefono del proveedor. Revise los datos y vuelva a intentarlo más tarde</h1>";
    }
}
